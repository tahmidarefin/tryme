...
export default function SingleChoice({preview, item, id}) {
    ...
    return (
        ...
        <div className="question">
            ...
            <div className="answer">
                ...
                <input type="radio" id={`${data["id"]} ${_key}`} name={`${data["id"]} 0`} value={_key} defaultChecked/> : 
                <input type="radio" id={`${data["id"]} ${_key}`} name={`${data["id"]} 0`} value={_key} />)}
                    {_value}</label>))}
            </div>
        </div> }
        </>
